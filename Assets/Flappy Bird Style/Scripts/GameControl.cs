...
{
    //private static bool skillzLaunched;
    ...
    public void BirdDied()
    {
        ...
        // Wait a few seconds before ending the Skillz match
        // so that the user can see that the game ended.
        //while (true)
        //{
        ...
        StartCoroutine(ReportFinalScore(score));
    }
